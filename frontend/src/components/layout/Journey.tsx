  ...
  return (
    <section className="bg-[#004c77] text-white py-16 px-4">
      ...
      <div className="flex items-center justify-center mb-12 relative">
        <div className="w-[400px] h-[2px] bg-white hidden sm:block rotate-90 absolute mr-335 mt-99.5"></div>
        ...
        <div className="w-[100px] h-[2px] bg-white hidden sm:block rotate-90 absolute right-27.5 bottom-17"></div>
      </div>
