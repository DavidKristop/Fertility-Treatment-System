...
export default function BecomingParentsSection() {
    return (
        <div className='grid grid-cols-1 gap-4 lg:grid-cols-12 lg:gap-0 lg:col-span-12 bg-blue-900/90 filter saturate-80 text-center'>
            <div className="h-full border-b-2 border-white col-start-2 col-span-2"></div>
            <h3 className="lg: col-span-6 text-white mt-12 text-2xl font-bold uppercase">Hành trình làm cha mẹ bắt đầu từ đây</h3>
            <div className="border-b-2 border-r-2 border-white col-start-10 col-span-2"></div>
            <div className="h-full border-l-2 border-white col-start-2 col-span-1"></div>

            <div className="w-[80%] h-auto lg:col-span-3 overflow-hidden flex-col justify-center items-center justify-self-center my-8">
